...
Revision ID: bac84f3a0c33
Revises: 2b051139821d
Create Date: 2025-09-16 18:53:53.650536
...
revision: str = 'bac84f3a0c33'
down_revision: Union[str, Sequence[str], None] = '2b051139821d'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['company_id'], ['company.company_id'], ),
    sa.ForeignKeyConstraint(['hr_id'], ['hr_manager.hr_id'], ),
    sa.PrimaryKeyConstraint('id'),
