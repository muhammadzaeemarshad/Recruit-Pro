...
Revision ID: d9a499dae9fa
Revises: 
Create Date: 2026-04-23 10:09:03.304732
...
def upgrade() -> None:
    ...
    sa.Column('selected_for_interview', sa.Boolean(), nullable=True),
    sa.Column('interview_scheduled', sa.Boolean(), nullable=True),
    sa.Column('interviewed', sa.Boolean(), nullable=True),
